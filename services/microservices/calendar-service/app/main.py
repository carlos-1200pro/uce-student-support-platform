...
SERVICE_NAME = os.getenv("SERVICE_NAME", "calendar-service")
...
def on_startup() -> None:
    calendar_service.startup()


@app.on_event("shutdown")
def on_shutdown() -> None:
    calendar_service.shutdown()
...
app.include_router(router, prefix=f"{BASE_PATH}/api" if BASE_PATH else "/api", tags=["calendar"])
