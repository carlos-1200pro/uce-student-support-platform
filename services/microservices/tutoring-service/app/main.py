...
SERVICE_NAME = os.getenv("SERVICE_NAME", "tutoring-service")
...
def on_startup() -> None:
    tutoring_service.startup()


@app.on_event("shutdown")
def on_shutdown() -> None:
    tutoring_service.shutdown()
...
app.include_router(router, prefix=f"{BASE_PATH}/api" if BASE_PATH else "/api", tags=["tutoring"])
